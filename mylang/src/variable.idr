...
-- simple demonstration; assigning a nat into a boolean variable
v: Variable Bool
v = variable_new nat_zero

-- making a nat into a natural number variable
n: Variable Nat
n = variable_new nat_two

-- making a nat into a UInt8 variable
u: Variable UInt8
